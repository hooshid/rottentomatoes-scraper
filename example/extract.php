...
<a href="/example/extract.php?<?php echo http_build_query($_GET); ?>&output=json" class="output-json-link">JSON Format</a>
            ...
            <div class="col-75">
                <table class="table">
                    ...
                    <?php if ($result['votes']) { ?>
                        <tr>
                            <td><b>Score:</b></td>
                            <td>score: <?php echo $result['score']; ?>, votes: <?php echo number_format($result['votes']); ?></td>
                        </tr>
                    <?php } ?>
